...
export default function Shop() {
    ...
    return (
        <div div className="h-screen overflow-y-auto overflow-x-hidden bg-fixed bg-no-repeat bg-center bg-cover" style={{ backgroundImage: `url(${background})` }}>
            <Navbar />
            <div className="pt-20 flex flex-wrap justify-start w-full">

                <div className="flex flex-col w-full md:w-3/12 justify-between items-center p-4">
                ...
                <div className="py-6 flex justify-center flex-wrap gap-x-4 gap-y-7 overflow-y-auto w-full md:w-9/12">
