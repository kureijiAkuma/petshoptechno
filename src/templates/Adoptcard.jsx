...
export default function AdoptCard(props){
    return(
        <button className="flex flex-col justify-center items-center relative ml-4 w-52 h-48 rounded-md bg-purple-50 shadow-md shadow-black/50 border-solid border border-pink-100/70 hover:bg-red-100 active:bg-red-200">
